    ...
    private void SetSizeDelat()
    {
        ...
        switch (_fitSide)
        {
            ...
            case FitSide.Right:
                ...
                break;
            case FitSide.Up:
                _ToWards = Screen.height / 2f - ThisRect.anchoredPosition.y - ThisRect.rect.width * ThisRect.localScale.y / 2f;
                _ToWards -= _distance * ThisRect.localScale.y;
                ThisRect.sizeDelta += new Vector2(_ToWards * ThisRect.localScale.y, 0);
                break;
            case FitSide.Down:
                _ToWards = Screen.height / 2f + ThisRect.anchoredPosition.y - ThisRect.rect.width * ThisRect.localScale.y / 2f;
                _ToWards -= _distance * ThisRect.localScale.y;
